...
namespace vkren
{
  ...
  struct DepthStencilAttachmentCreateInfo
  {
    VkFormat Format;
    VkExtent2D Extent;
  ...
  {
  public:
    static Ref<DepthStencilAttachment> Create(const DepthStencilAttachmentCreateInfo& info);
    static Ref<DepthStencilAttachment> Create
    (
