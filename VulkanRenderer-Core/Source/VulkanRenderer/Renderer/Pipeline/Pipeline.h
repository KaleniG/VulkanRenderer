...
namespace vkren
{
  ...
  typedef uint32_t MultisampleMask;
  ...
  public:
    ...
    void AddAttachmentState(VkColorComponentFlags color_write_mask = VKREN_DEFAULT_COLOR_BLEND_MASK);
    void AddAttachmentState(VkBlendFactor src_color_blend_factor, VkBlendFactor dst_color_blend_factor, VkBlendOp color_blend_op, VkBlendFactor src_alpha_blend_factor, VkBlendFactor dst_alpha_blend_factor, VkBlendOp alpha_blend_op, VkColorComponentFlags color_write_mask = VKREN_DEFAULT_COLOR_BLEND_MASK);
  ...
  {
  public:
    void AddDescriptorSetLayout(const Ref<DescriptorSetLayout>& layout);
  ...
  public:
    ...
    static Ref<PipelineLayout> Create(const PipelineLayoutStructure& structure);
